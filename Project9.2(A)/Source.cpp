...
bool BinSearch(Students* S, const int N, const string surname, const int speciality, const int grade_computer_science);
...
int main()
{
    ...
    do
    {
        ...
        case 5:
            ...
            if (BinSearch(S, N, B_surname, B_speciality, B_grade_computer_science) == 1)
